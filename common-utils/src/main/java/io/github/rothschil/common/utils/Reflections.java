            ...
            for (Field targField : targetFields) {
                ...
                for (Field sourceField : sourceFields) {
                    ...
                    if (targFieldName.equals(sourceFieldName) && targFieldType.equals(sourceFieldType)) {
                        String fieldGetName = StringUtils.parGetName(sourceField.getName());
                        if (!StringUtils.checkGetMet(sourceMethods, fieldGetName)) {
                            continue;
                        }
                        ...
                        //Set Method
                        String fieldSetName = StringUtils.parSetName(targField.getName());
                        if (!StringUtils.checkGetMet(targetMethods, fieldSetName)) {
                            continue;
                        }
