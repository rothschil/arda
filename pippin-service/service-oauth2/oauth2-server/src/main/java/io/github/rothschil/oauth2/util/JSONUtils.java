package io.github.rothschil.oauth2.util;
...
import io.github.rothschil.oauth2.util.enums.DateFormatEnum;
...
public class JSONUtils {
    ...
    public static <T> T toObject(InputStream src, Class<T> responseType) {
        try {
            ...
            throw new DrunkardException(Status.IO_EXCEPTION.getStatus(), "从输入流中读取数据对象异常，" + e);
        }
    }
