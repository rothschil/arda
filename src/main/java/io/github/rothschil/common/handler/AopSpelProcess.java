...
public class AopSpelProcess {
    ...
    private final AopSpelExpressionEvaluator cachedExpressionEvaluator = new AopSpelExpressionEvaluator();
    ...
    public HashMap<String, String> ternaryProcess(HashMap<String, String> map,
        ...
        for (Map.Entry<String, String> entry : entries) {
            ...
            try {
                ...
                log.error("解析操作日志SpEL出错 ={}", e.getMessage());
            }
        }
        return map;
    }
