...
import xyz.wongs.drunkard.framework.shiro.session.OnlineSessionFactory;
import xyz.wongs.drunkard.framework.shiro.web.filter.LogoutFilter;
import xyz.wongs.drunkard.framework.shiro.web.filter.captcha.CaptchaValidateFilter;
import xyz.wongs.drunkard.framework.shiro.web.filter.kickout.KickoutSessionFilter;
import xyz.wongs.drunkard.framework.shiro.web.filter.online.OnlineSessionFilter;
...
public class ShiroConfig {
    ...
    public EhCacheManager getEhCacheManager() {
        net.sf.ehcache.CacheManager cacheManager = net.sf.ehcache.CacheManager.getCacheManager("pippin");
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/pippin.png**", "anon");
        ...
        filterChainDefinitionMap.put("/pippin/**", "anon");
