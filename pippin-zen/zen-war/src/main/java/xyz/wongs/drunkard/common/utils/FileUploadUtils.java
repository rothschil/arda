...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = DrunkardConfig.getProfile();
    ...
    public static final String extractFilename(MultipartFile file) {
        ...
        fileName = DateUtils.datePath() + "/" + StringUtils.getUuid() + "." + extension;
        return fileName;
    }
    ...
    private static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = DrunkardConfig.getProfile().length() + 1;
