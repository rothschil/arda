package xyz.wongs.drunkard.war.web.controller.common;
...
import xyz.wongs.drunkard.common.utils.FileUtils;
...
public class CommonController {
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response) {
        try {
            ...
            String filePath = DrunkardConfig.getDownloadPath() + fileName;
    ...
    public void resourceDownload(String resource, HttpServletResponse response)
        ...
        try {
            ...
            // 本地资源路径
            String localPath = DrunkardConfig.getProfile();
            // 数据库资源地址
