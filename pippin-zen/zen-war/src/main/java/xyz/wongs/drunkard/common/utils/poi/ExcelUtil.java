package xyz.wongs.drunkard.common.utils.poi;
...
import xyz.wongs.drunkard.common.annotation.Excel.Type;
...
public class ExcelUtil<T> {
    ...
    public AjaxResult exportExcel() {
        ...
        try {
            ...
            throw new DrunkardException("导出Excel失败，请联系网站管理员！");
        } finally {
            if (wb != null) {
                try {
                    wb.close();
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = DrunkardConfig.getDownloadPath() + filename;
