...
/**
 * 属于自定义异常，使用过程中，需要注意构造函数 {@link xyz.wongs.drunkard.base.response.enums.Status} 中的定义，是否满足要求，不满足的话
 * 则扩展 {@link xyz.wongs.drunkard.base.response.enums.Status} 枚举值
 *
 * @author WCNGS@QQ.COM
...
public class DrunkardException extends RuntimeException {
    ...
    /**
     * 利用 {@link xyz.wongs.drunkard.base.response.enums.Status} 定义的枚举来创建异常信息
     *
     * @param status {@link xyz.wongs.drunkard.base.response.enums.Status} 类
